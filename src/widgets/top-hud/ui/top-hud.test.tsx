...
describe('TopHud', () => {
    ...
    it('кнопки ± угла визуально 32px, но с расширенной до 44px зоной нажатия (#450)', () => {
        ...
        // Зона нажатия ≥44×44 — псевдоэлемент `before:-inset-2` расширяет бокс на
        // 8px во все стороны (48×48); тач-цель шире визуального бокса, раскладку
        // не растит.
        expect(plus.className).toContain('before:-inset-2');
    });
