 ...
 * угла (ревью #579). При текущих значениях `LEAN_DEG_BY_MAGNITUDE` (макс 90°) угол
 * полотнища не превышает 180°, поэтому порог «угол > 90°» совпадает со знаком ветра
 * структурно, и сторона совпадает со знаком направления независимо от наклона.
 */
