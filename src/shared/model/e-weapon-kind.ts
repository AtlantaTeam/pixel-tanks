...
export enum EWeaponKind {
    ...
    /**
     * Крупнее радиус, горячее ядро, ударная волна по фронту и сильнее тряска
     * камеры. Урон и импульс отдачи (`Tank.jumpOnHit`) считаются от `power`
     * одинаково для всех типов (визуальная фаза) — «мощь» здесь про вид, не про
     * больший нокбэк.
     */
    Heavy = 'heavy',
