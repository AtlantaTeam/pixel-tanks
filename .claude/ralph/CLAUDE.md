...
| `core/review-of-fixes.ts`                       | Лестница «ревью правок» (#625): чистая арифметика второго прохода ПО ПРАВКАМ — дедуп находок между кругами, потолок проходов (растёт только от НОВЫХ blocker/major), анти-пинг-понг, решение «мердж / ещё круг / независимый арбитр», тексты карточек                                                                                                      | мердж держат только blocker/major; косметика уходит карточками, а не задержкой; лестница конечна ДОКАЗУЕМО (потолок + предохранитель кругов), последняя ступень — арбитр, а не стоп человеку                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
