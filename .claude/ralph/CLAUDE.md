...
13. **Ревью правок не имеет права стать вторым стопом** (#625). Правки по ревью — код,
    ...
    **Где человек всё-таки появляется** (#628): терминал «арбитр ВОСПРОИЗВЁЛ блокер» ведёт
    ...
    находка по новому коду поднимает арбитра при любом состоянии на диске. Формулировать это
    как «состояние живёт ровно один цикл сдачи» нельзя — следующий агент чинил бы не то.
