...
`looksBlind`) и fail-closed сверяет, что в набор попал каждый из 19 файлов ядра — 14 TS-модулей,
3 рантайм-JS, `ralph.js` и `gate-env.js` — плюс `scripts/project-sync.mjs`.
