...
// включает **/*.ts и **/*.mts, поэтому этот .js-файл вне периметра typecheck:ralph — как и
// оставшийся тест .js-модуля monitor.test.js; orchestrator.ts сам по себе
// остаётся типизированным и проверяемым (как и уже переведённые deadman.test.ts/
// telegram-notifier.test.ts/gate-env.test.mts).
//
