...
Родилась как курсовая команды **Atlanta Team** (Яндекс.Практикум, 2021). Сейчас переживает второе рождение: полный rewrite на современный стек — причём **код фаз пишет автономный агент** (Ralph Loop на Claude), а люди занимаются геймдизайном и ревью.
...
**Atlanta Team** — курсовая 2021 → next-gen rewrite 2026.
