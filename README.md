...
| 📱 Тач                      | «оттяни и отпусти» — как рогатка |
...
- **Своя UI-тема** — DotGothic16 + JetBrains Mono (+ Montserrat, Press Start 2P), NES-рамки, кастомная dark-палитра с faction-темами (витрина [`/design-system`](https://pixeltanks.ru/design-system))
