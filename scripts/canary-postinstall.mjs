...
try {
    ...
    // Прогон 1: как в гейте, скрипты зависимостей по умолчанию заблокированы npm 11.
    runNpm(
        ['ci', '--no-audit', '--no-fund'],
        'npm ci — путь гейта (install-скрипты зависимостей по умолчанию заблокированы npm 11)',
    );
